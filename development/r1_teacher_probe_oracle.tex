...
\date{2026-08-22; 구현·검증 근거 갱신 2026-09-20}
\renewcommand{\DevChecklistDate}{2026-09-20}
...
셀프컬리전 탐지/접촉 응답/마찰/CCD 및 공간 분할 가속은 미구현이다.
후속 접촉 모델은 별도 개발 후보로 설계해야 하며 기존 contact-off 연구 계약을 자동 해제하지 않는다.
